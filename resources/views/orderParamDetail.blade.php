...
<div class="bg-dark-bg-secondary rounded-lg shadow-lg p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-dark-text-primary">Order Details</h2>
    ...
    <div class="space-y-6">
        <div class="bg-dark-bg-primary rounded-lg p-4 border border-dark-border">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-dark-text-secondary mb-1">Customer Name</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-dark-text-secondary mb-1">Date</label>
                    <div class="text-lg font-medium text-dark-text-primary">{{ $orderDate }}</div>
                </div>
            </div>
        </div>
    </div>
